...
class Livro(models.Model):
    ...
    id_admnistrador = models.IntegerField(Administrador, on_delete=models.SET(-1)) #chave estrangeira, eu deletar administrador seta valor para -1
...
class Livros_Leitor(models.Model):
    cpf = models.ForeignKey(Leitor, primary_key=True, on_delete=models.CASCADE) #chave estrangeira, chave primária
    ISBN = models.ForeignKey(Livro, primary_key=True, on_delete=models.CASCADE) #chave estrangeira, chave primária
